...
public class Primitive extends restservices.proxies.AnyObject
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("VehicleLookUp.AdvisoryObj", mendixObject.getType()))
			return vehiclelookup.proxies.AdvisoryObj.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("VehicleLookUp.FailuresObj", mendixObject.getType()))
